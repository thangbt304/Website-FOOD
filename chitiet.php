...
if (isset($_GET['masp'])) {
    ...
    $sql_comments = "SELECT b.*, t.tentk FROM binhluan b JOIN taikhoan t ON b.matk = t.matk WHERE b.masp = '$masp' ORDER BY b.ngaytao DESC";
    $comments = mysqli_query($connection, $sql_comments);
} else {
...
<body>
    ...
    <main>
        <div class="main_conten">
            ...
            <h1>Shop Detail</h1>  <br><br><br>
        </div>
    <div class="detail">
        <div class="detail-1">
            <div class="detail-1_2">
                <img src="<?php echo $sanpham['hinhanh']; ?>" style="width: 700px; height: 500px;object-fit: cover; border: 3px solid #e5c591; border-radius: 40px;" alt="<?php echo $sanpham['tensp']; ?>">
            
                <div class="conten3" style="margin-left: 20px;">
                    <div class="title"> 
                        <h1 style="color: #e5c591; font-size: 30px; padding-bottom: 10px;"><?php echo $sanpham['tensp']; ?></h1>
                        <p style="font-size: 20px;color: #9d9c9c;">Category: Food</p><br>
                        <p style="font-family: serif; font-size: 30px;color: #e5c591;">$<?php echo $sanpham['dongia']; ?></p>
                        <img src="./imge/rating.png" width="150px">
                    </div>
                    <p style="font-size: 20px;color: #cecaca;">Information: <p style="font-size: 20px;color: #9d9c9c;"><?php echo $sanpham['mota']; ?></p></p> <br>
                    <p style="font-size: 20px;color: #9d9c9c;">As type 1 of the restaurant's dishes, it is very requested by many diners and has a lot of good comments every day.</p>
                </div>
            </div>
    ...
    <div class="comment-section">
        ...
        <?php while ($comment = mysqli_fetch_assoc($comments)) { ?>
            <div class="comment">
                <p class="comment-author"><?php echo ($comment['tentk']); ?></p>
                <p class="comment-date"><?php echo $comment['ngaytao']; ?></p>
        ...
        <?php if ($matk) { ?>
            <div class="add-comment">
                ...
                <form action="add_comment.php" method="POST">
                    <textarea name="noidung" rows="4" required></textarea>
